<x-guest-layout>
    ...
    <div class="text-center mb-6">
        <h2 class="text-xl sm:text-2xl font-bold text-white">Crear Cuenta</h2>
        <p class="text-indigo-300/60 text-sm mt-1">Comienza a controlar tus finanzas</p>
    </div>
    ...
    <div class="mt-6 pt-5 border-t border-white/10 text-center">
        <p class="text-indigo-300/50 text-sm">¿Ya tienes cuenta?</p>
        <a href="{{ route('login') }}"
